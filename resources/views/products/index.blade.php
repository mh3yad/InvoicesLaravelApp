...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">{{__('products')}}</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0"></span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content modal-content-demo">
                <div class="modal-header">
                    <h6 class="modal-title">{{__('Add product')}}</h6>
        ...
        <div class="col-sm-4 col-md-4">
            <div class="card custom-card">
                <div class="card-body">
                    ...
                    <a class="btn ripple btn-success" data-target="#modaldemo1" data-toggle="modal" href="">
                        {{__('Add product')}}</a>
                </div>
            </div>
        </div>
                    ...
                    <div class="table-responsive">
                        <table class="table text-md-nowrap" id="example1">
                            ...
                            <tr>
                                ...
                                <th class="wd-15p border-bottom-0">{{__('product')}}</th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex mr-2">
                                            <div>
                                                <div class="modal" id="modaldemo2">
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content modal-content-demo">
                                                            <div class="modal-header">
                                                                <h6 class="modal-title">{{__('Edit product')}}</h6>
                                                                <button aria-label="Close" class="close"
                                                                        data-dismiss="modal" type="button"><span
                                                                        aria-hidden="true">&times;</span></button>
                                                            </div>
                                                            <form action="{{route('products.update',[$section->id,app()->getLocale()])}}"
                                                                  method="POST">
                                                                @method("PUT")
                                                                @csrf
                                                                <div class="modal-body">
                                                                ...
                                                                <div class="modal-footer">
                                                                    ...
                                                                    <button class="btn ripple btn-secondary"
                                                                            data-dismiss="modal" type="button">{{__('cancel')}}
                                                                    </button>
                                                                </div>
                                                            </form>
                                                        </div>
                                            ...
                                            <div class="mr-2">
                                                <form action="{{route('products.destroy',[app()->getLocale(),$section->id])}}" method="POST">
                                                    @method('DELETE')
                                                    @csrf
