					...
					<div class="main-header-right">
						...
						<div class="nav nav-item  navbar-nav-right ml-auto">
                                    ...
                                    <div class="menu-header-content bg-primary text-right">
                                        <div class="d-flex">
                                            ...
                                            <span class="badge badge-pill badge-warning mr-auto my-auto float-left"><a
                                                    href="/markAsRead">{{__('Mark All Read')}}</a></span>
                                        </div>
                                        <p class="dropdown-title-text subtext mb-0 text-white op-6 pb-0 tx-12 ">{{__('You hav')}} <span id="notifications_count"> {{count(auth()->user()->unReadNotifications)}} </span>{{__('unread Notifications')}}</p>
                                    </div>
                                    <div id="unreadNotifications" class="main-notification-list Notification-scroll">

                                        @foreach(auth()->user()->Notifications as $notification)
                                            <div  style="{{$notification->unread() ? 'background:#ddf2ff' : ""}}">
                                                <a class="d-flex p-3 border-bottom" href="{{route('notificationDetails',[app()->getLocale(),$notification->id])}}">
                                                    <div class="notifyimg bg-warning">
                                                        <i class="la la-envelope-open text-white"></i>
                                                    </div>
                                                    <div class="mr-3">
                                                        <h5 class="notification-label mb-1">{{__('New Invoice created by')}} {{$notification->data['createdBy']}}</h5>
                                                        <div class="notification-subtext"><strong>{{now()->diffInMinutes($notification->created_at)}} </strong> {{__('minutes ago')}}</div>
                                                    </div>
                                                    <div class="mr-auto" >
							...
							<div class="dropdown main-profile-menu nav nav-item nav-link">
								<a class="profile-user d-flex" href=""><img alt="" src="https://pbs.twimg.com/profile_images/1260511303866736640/imUO4pSa_400x400.jpg"></a>
								<div class="dropdown-menu">
									<div class="main-header-profile bg-primary p-3">
										<div class="d-flex wd-100p">
											<div class="main-img-user"><img alt="" src="https://pbs.twimg.com/profile_images/1260511303866736640/imUO4pSa_400x400.jpg" class=""></div>
                                    ...
                                    <a class="dropdown-item" href="{{ route('logout',app()->getLocale()) }}"
                                       ...
                                       document.getElementById('logout-form').submit();">
                                        <i class="bx bx-log-out"></i>{{__('signout')}}</a>
