...
<aside class="app-sidebar sidebar-scroll">
    ...
    <div class="main-sidemenu">
        ...
        <ul class="side-menu">
            <li class="side-item side-item-category">فواتيرك</li>
            <li class="slide">
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    ...
                    <li><a class="slide-item" href="{{ url('/paid') }}">الفواتير المدفوعة</a></li>
                    <li><a class="slide-item" href="{{ url('/partial') }}">الفواتير المدفوعة جزئيا</a> </li>
                    <li><a class="slide-item" href="{{ url('/unpaid') }}">الفواتير الغير المدفوعة </a></li>
                    <li><a class="slide-item" href="{{ url('/archive_view') }}">الفواتير المؤرشفة</a> </li>
                </ul>
            </li>
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/users') }}">
                    <svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24">
                        <path d="M0 0h24v24H0V0z" fill="none"/>
                ...
                <ul class="slide-menu">
                    ...
                    <li><a class="slide-item" href="{{ url('/roles') }}">صلاحيات المستخمين</a></li>
                </ul>
            @endcan
            </li>
